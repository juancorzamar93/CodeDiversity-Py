...
print("{:>5d} {:>10.2f} {:>10.2f} {:>10.2f}".format("Year", "Loan at start", "Interest", "Loan at end"), file=out)

for year in range(time):
    loan_at_start = loan_at_end
    interest = loan_at_end * (rate/100)
    loan_at_end += interest
    print("{:>5d} {:>10.2f} {:>10.2f} {:>10.2f}".format(year, loan_at_start, loan_at_end), file=out)
